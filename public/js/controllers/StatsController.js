angular.module('BlocksApp').controller('StatsController', function($stateParams, $rootScope, $scope) {
    ...
    /*
      Chart types: 
        ...
        miner_hashrate: Validator Hashrate Distribution
    */
    ...
    const CHART_TYPES = {
        ...
        "miner_hashrate": {
            "title": "Validator Hashrate Distribution"
        },
        "supply": {
            "title": "Total Supply"
        },
  ...
  return {
    ...
    link: function(scope, elem, attrs) {
      ...
      scope.init = function(dataset, chartid) {
        ...
        var maxValidators = 23;
        if (window.innerWidth < 800) {
            var legendHeight = legendRectSize + legendSpacing;
            var fixHeight = Math.min(maxValidators, dataset.length) * legendHeight;
        ...
        function change(data) {
            ...
            var legendHeight = Math.min(maxValidators, color.domain().length);
            var legend = svg.selectAll('.legend')
                ...
                .attr('transform', function (d, i) {
                    if (data.length - i >= maxValidators) {
                        // show maxValidators, hide remains
